...
# update bop_boolkit
import sys
sys.path.insert(0, '/home/robot/6dof-grid/bop_toolkit')
...
for i in range(args.num_scenes):
    ...
    sampled_target_bop_objs = list(np.random.choice(target_bop_objs, size=4, replace=False))
    ...
    for obj in (sampled_target_bop_objs):        
        ...
        mat.set_principled_shader_value("Metallic", np.random.uniform(0, 0.3))
